...
| ~Aug 2026    | API 36 required — _projected per Google's annual pattern, not yet formally announced_ |
| ~Aug 2027    | API 37 required — _projected per Google's annual pattern, not yet formally announced_ |
