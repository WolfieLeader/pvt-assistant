...
- Clean, readable, intuitive, consistent, and simple code
- Use meaningful, descriptive names
- Use best practices, conventions, and principles
- Good error handling and edge case handling for bug-free code
- Performance and optimization
- Minimal comments — only for complex logic that isn't self-evident
- casing: file - kebab, code - camel, SQL schema - snake
