...
```jsx
const SettingsScreen = React.lazy(() => import(/* webpackChunkName: "settings" */ "./screens/SettingsScreen"));
...
const HeavyFeature = React.lazy(() => import(/* webpackChunkName: "heavy-feature" */ "./HeavyFeature"));
